...
import com.jizhang.adapter.CommonAdapter;
...
import com.jizhang.view.NoScrollListView;
...
public class PieIncomeFgt extends BaseFragment implements DatePickerDialog.OnDateSetListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mPieChartData.setCenterText1Color(getResources().getColor(R.color.gray));
        mPieChartData.setCenterText2Color(getResources().getColor(R.color.gray));
